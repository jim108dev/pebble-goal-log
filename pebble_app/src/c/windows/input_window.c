...
static void click_provider(void *context)
{
  ...
  window_long_click_subscribe(BUTTON_ID_UP, 0, on_up, NULL);
  ...
  window_long_click_subscribe(BUTTON_ID_DOWN, 0, on_down, NULL);
}
...
static void window_load(Window *window)
{
  ...
  GRect main_bounds = GRect(PADDING, ROW_HEIGHT, bounds.size.w - PADDING, inputs_y);
